...
function generarPDF($serie,$folio){
	...
	//Datos de Emisor
	$q1 = "SELECT * FROM ppatron p INNER JOIN pdireccion d ON p.iddireccion=d.id WHERE p.id=".$_POST['registropatronal'];
	$s1 = $conexion->query($q1);
	...
	$pdf->SetXY(145,-45);
	$pdf->SetFont('Arial','b',8);
	$pdf->MultiCell(62,3,utf8_decode('RECIB� DE '.strtoupper($EmisorNombre).' EL TOTAL NETO SE�ALADO Y ESTOY DE ACUERDO CON LO INDICADO.'),0,'C');
